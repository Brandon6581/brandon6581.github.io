...
const ACTIVE_COLOR = '#8FD694';
const INACTIVE_COLOR = '#7A80A0';
    ...
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: Platform.select({
          ...
          default: { backgroundColor: '#141626' },
        }),
      }}>
      <Tabs.Screen
        name="index"
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Slimes',
          tabBarIcon: ({ color }) => <IconSymbol size={26} name="circle.grid.3x3.fill" color={color} />,
        }}
      />
      <Tabs.Screen
        name="upgrades"
